...
function __promptline_ps1 {
  ...
  [ $is_prompt_empty -eq 1 ] && slice_prefix="$slice_empty_prefix"
  # section "x" slices
  __promptline_wrapper "$_promptline_vim_mode" "$slice_prefix" "$slice_suffix" && { slice_prefix="$slice_joiner"; is_prompt_empty=0; }
  ...
  [ $is_prompt_empty -eq 1 ] && slice_prefix="$slice_empty_prefix"
  # section "y" slices
  __promptline_wrapper "$_promptline_exit_code" "$slice_prefix" "$slice_suffix" && { slice_prefix="$slice_joiner"; is_prompt_empty=0; }
...
function __promptline_right_prompt {
  ...
  # section "x" slices
  __promptline_wrapper "$_promptline_vim_mode" "$slice_prefix" "$slice_suffix" && { slice_prefix="$slice_joiner"; }
  ...
  # section "y" slices
  __promptline_wrapper "$_promptline_exit_code" "$slice_prefix" "$slice_suffix" && { slice_prefix="$slice_joiner"; }
...
function __promptline {
  ...
  local a_bg="${wrap}48;5;67${end_wrap}"
  local a_sep_fg="${wrap}38;5;67${end_wrap}"
  local b_fg="${wrap}38;5;67${end_wrap}"
  ...
  local y_fg="${wrap}38;5;67${end_wrap}"
